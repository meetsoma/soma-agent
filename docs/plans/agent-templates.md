...
This would be the reference implementation. Every protocol, every pattern, the full behavior cascade. The template that built the templates. Private for now (it's literally `meetsoma/somas-daddy`), but it shows the ceiling of what a template can be.
